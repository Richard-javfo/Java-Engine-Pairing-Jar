 ...
 * @author DP
 */
public record Round(int roundNr, int opponentStartRank, char color, char result) {
    ...
    public Round withResult(char newResult) {
        return new Round(this.roundNr, this.opponentStartRank, this.color, newResult);
    }
